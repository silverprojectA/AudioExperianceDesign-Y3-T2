...
const int slide = A3;     // sensor to control blue color

const int tog1 = 9;     // sensor to control blue color
const int tog2 = 8;
const int tog3 = 7;
const int tog4 = 6;
...
void loop() {
  ...
  Serial.print(digitalRead(tog1));

  Serial.print(",");

  Serial.print(digitalRead(tog2));

  Serial.print(",");

  Serial.print(digitalRead(tog3));

  Serial.print(",");

  Serial.println(digitalRead(tog4));
